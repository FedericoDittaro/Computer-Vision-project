...
In questo progetto è stata affrontata la problematica della segmentazione delle immagini utilizzando un approccio basato su deep learning creando un dataset personalizzato di
immagini e le rispettive maschere di segmentazione attraverso l’ambiente di simulazione NVIDIA Omniverse. La piattaforma Omniverse ha permesso di generare un dataset sintetico di 
